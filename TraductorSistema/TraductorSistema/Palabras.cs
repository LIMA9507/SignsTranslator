    ...
    public partial class Palabras : Form
    {
      ...
      /*  private void salir_Click(object sender, EventArgs e)
        ...
        private void Palabras_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
             ...
             MessageBox.Show("No se encontro la base de datos para las palabras ","Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
      ...
      /*  private void lOGINToolStripMenuItem1_Click(object sender, EventArgs e)
        ...
        private void lpalabras_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se encontro la base de datos para el traductor", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
